...
public:
    ...
    static constexpr int SampleRate = Apu::SampleRate;
    ...
    [[nodiscard]] bool loadCore(const std::string& corePath);
    ...
    [[nodiscard]] const std::string& corePath() const;
...
[[nodiscard]] std::string resolveLibretroGbaCorePath();
